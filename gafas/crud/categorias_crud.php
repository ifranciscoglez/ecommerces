...
if(!empty($_POST)){
    ...
    $descripcion = $_POST['descrip-categoria'];

    #$img = isset($_POST['imagen']) ? $_POST['imagen'] : null;

    if(!empty($id) && !empty($nombre) && !empty($descripcion)){
        
    $sql = "UPDATE categoria SET nombreCategoria='$nombre', descripCategoria='$descripcion'
  ...
  <head>
    ...
    <title>Administración</title>
     ...
     <link href="../css/bootstrap.min.css" rel="stylesheet">
		...
		<script src="peticion_categoria.js"></script>
  </head>
  <body>
              ...
              <a class="nav-item nav-link" id="modificar-tab" href="#modificar" role="tab" data-toggle="tab" role="tab" aria-controls="nav-" aria-selected="false">Modificar</a></li>
                ...
                <div class="row">
                    <div class="col-xs-12 col-sm-6">
                        <br><br>
                        <div id="agregar">
                            <h2 class="text-primary text-center"><small><i class="fa fa-plus"></i></small>&nbsp;&nbsp;Agregar categoria</h2>
                            <form role="form" action="guardar_categoria.php" method="post" enctype="multipart/form-data">
                            
                              <div class="form-group">
                                <label>Nombre categoria</label>
                                <input type="text" class="form-control"  placeholder="Nombre de la categoria" required maxlength="45" minlength="5" name="nombre-categoria">
                              </div>
                             <div class="form-group">
                                <label>Descripción categoria</label>
                                <input type="text" class="form-control"  placeholder="Descripción de la categoria" required minlength="150" name="descrip-categoria">
                              </div>
 
                              <div class="form-group">
                                <label>Imagen gafa</label>
                                <input type="file" name="img-categoria">
                ...
                <div class="row">
                 <div class="col-xs-12 col-sm-6">
                        <br><br>
                        <div id="modifcar">
                            <h2 class="text-primary text-center"><small><i class="fa fa-plus"></i></small>&nbsp;&nbsp;Buscar categoria</h2>
                          <section>
