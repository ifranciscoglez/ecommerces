         ...
         <div class="form-row">
          ...
          <div class="form-row">
            ...
            <div class="form-group col-md-4">
              ...
              <input type="text" class="form-control" name="inputState" placeholder="Guerrero" required maxlength="45">
            </div>
            <div class="form-group col-md-6">
              <label for="inputColony">Colonia</label>
              <input type="text" class="form-control" name="inputColony" placeholder="Lazaro" required maxlength="45">
            </div>
            <div class="form-group col-md-2">
              <label for="inputZip">Codigo Postal</label>
              <input type="text" class="form-control" name="inputZip" placeholder="39888" required pattern="[0-9]+" maxlength="5" minlength="5">
            </div>
          </div>
          <div class="form-row">
          <div class="form-group col-md-8">
            <label for="inputAddress">Direccion</label>
            <input type="text" class="form-control" name="inputAddress" placeholder="Costera Miguel Aleman" required maxlength="300">
          </div>          
           <div class="form-group col-md-2">
            <label for="inputNumInt">Número Interior</label>
            <input type="text" class="form-control" name="inputNumInt" placeholder="05" required pattern="[0-9]+" maxlength="2">
          </div>          
          <div class="form-group col-md-2">
            <label for="inputNumExt">Número Exterior</label>
            <input type="text" class="form-control" name="inputNumExt" placeholder="03" required pattern="[0-9]+" maxlength="2">
          </div>
          </div>
